...
<header>
    ...
    <?php echo anchor(base_url('departamento/create'), 'Novo Departamento', ['class' => 'btn btn-secondary mb-3 justify-content-center']) ?>
        <table class="table table-hover table-striped table-bordered" style="text-align:center">
            ...
            <?php foreach($departamentos as $departamento): ?>
                <tr>
                    ...
                    <td><?php echo $departamento['setor'] ?></td>
                    <td>
                        <?php echo anchor('departamento/edit/' . $departamento['id'], 'Editar', ['class' => 'btn btn-info mb-3']) ?>
                        <?php echo anchor('departamento/delete/' . $departamento['id'], 'Excluir', ['class' => 'btn btn-danger mb-3', 'onclick' => 'return confirma()']) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
